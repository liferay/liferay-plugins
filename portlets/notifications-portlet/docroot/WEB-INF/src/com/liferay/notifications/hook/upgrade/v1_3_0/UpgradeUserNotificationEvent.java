...
public class UpgradeUserNotificationEvent extends UpgradeProcess {
	...
	protected void upgradeNotificationEvents() throws Exception {
		...
		try {
			...
			sb.append("select * from UserNotificationEvent une full outer ");
			sb.append("join Ntfctns_UserNotificationEvent ntf on ");
			sb.append("une.userNotificationEventId=");
			sb.append("ntf.userNotificationEventId where une.archived=0 ");
			sb.append("and ntf.userNotificationEventId is null");
