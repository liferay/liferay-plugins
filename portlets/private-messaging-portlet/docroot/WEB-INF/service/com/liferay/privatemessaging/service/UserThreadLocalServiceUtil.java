	...
	*/
	...
	public static com.liferay.portlet.messageboards.model.MBMessage addPrivateMessageBranch(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addPrivateMessageBranch(userId, parentMessageId, subject,
			body, files);
	}
	...
	public static void addUserThread(long userId, long mbThreadId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().addUserThread(userId, mbThreadId, read, deleted);
	}
	...
	public static java.util.List<com.liferay.privatemessaging.model.UserThread> getUserThreadsByUserId(
		long userId, boolean deleted)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getUserThreadsByUserId(userId, deleted);
	}
	...
	public static java.util.List<com.liferay.privatemessaging.model.UserThread> getUserThreadsByUserId(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getUserThreadsByUserId(userId, deleted, start, end);
	}
	...
	public static java.util.List<com.liferay.privatemessaging.model.UserThread> getUserThreadsByUserId(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getUserThreadsByUserId(userId, read, deleted);
	}

	public static java.util.List<com.liferay.privatemessaging.model.UserThread> getUserThreadsByMBThreadId(
		long mbThreadId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getUserThreadsByMBThreadId(mbThreadId);
	}

	public static int getUserThreadCount(long userId, boolean deleted)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getUserThreadCount(userId, deleted);
	}

	public static int getUserThreadCount(long userId, boolean read,
		boolean deleted)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getUserThreadCount(userId, read, deleted);
	}
