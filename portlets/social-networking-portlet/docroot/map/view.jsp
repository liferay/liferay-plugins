							...
							<c:choose>
								<c:when test="<%= windowState.equals(WindowState.MAXIMIZED) %>">
									var infoWindow = new google.maps.InfoWindow(
										{
											content: '<center><img alt="<%= HtmlUtil.escapeJS(LanguageUtil.get(pageContext, "user-portrait")) %>" src="<%= mapUser.getPortraitURL(themeDisplay) %>" width="65" /><br /><%= HtmlUtil.escapeJS(HtmlUtil.escape(mapUser.getFullName())) %></center>'
										}
									);
