...
public class TasksEntryFinderUtil {
	...
	public static java.util.List<com.liferay.tms.model.TasksEntry> findByG_P_A_R_S_T_N(
	...
	public static TasksEntryFinder getFinder() {
		if (_finder == null) {
			_finder = (TasksEntryFinder)PortletBeanLocatorUtil.locate(com.liferay.tms.service.ClpSerializer.getServletContextName(),
