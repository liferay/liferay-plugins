			...
			<table class="lfr-table">
				...
				%>
						...
						<tr>
							...
							<td align="right">
								<%= decimalFormat.format(stocks.getLastTrade()) %>
							</td>
							<td align="right">
								<c:if test="<%= stocks.getChange() < 0 %>">
									<span class="alert alert-danger">
										<%= decimalFormat.format(stocks.getChange()) %>
									</span>
								</c:if>
					...
					<table border="1" cellpadding="0" cellspacing="0" width="579">
						<tr>
							...
							<td align="center">
								...
								<strong><%= decimalFormat.format(stocks.getDayHigh()) %></strong>
							</td>
							<td align="center">
								<liferay-ui:message key="day-low" /><br />

								<strong><%= decimalFormat.format(stocks.getDayLow()) %></strong>
							</td>
							<td align="center">
								<liferay-ui:message key="open" /><br />

								<strong><%= decimalFormat.format(stocks.getOpen()) %></strong>
							</td>
							<td align="center">
								<liferay-ui:message key="previous-close" /><br />

								<strong><%= decimalFormat.format(stocks.getPreviousClose()) %></strong>
							</td>
							<td align="center">
								<liferay-ui:message key="volume" /><br />

								<strong><%= numberFormat.format(stocks.getVolume()) %></strong>
							</td>
						</tr>
					</table>
