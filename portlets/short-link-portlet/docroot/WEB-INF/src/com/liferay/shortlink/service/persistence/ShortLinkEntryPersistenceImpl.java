...
public class ShortLinkEntryPersistenceImpl extends BasePersistenceImpl<ShortLinkEntry>
		...
		if ((list != null) && !list.isEmpty()) {
			for (ShortLinkEntry shortLinkEntry : list) {
				if (!Validator.equals(modifiedDate,
							shortLinkEntry.getModifiedDate())) {
					list = null;
	...
	public void removeByLtModifiedDate(Date modifiedDate)
		throws SystemException {
		for (ShortLinkEntry shortLinkEntry : findByLtModifiedDate(modifiedDate)) {
			remove(shortLinkEntry);
		}
	}
	...
	public int countByShortURL(String shortURL) throws SystemException {
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_SHORTURL,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_SHORTURL,
					finderArgs, count);
	...
	public int countByOURL_A(String originalURL, boolean autogenerated)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_OURL_A,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_OURL_A,
					finderArgs, count);
