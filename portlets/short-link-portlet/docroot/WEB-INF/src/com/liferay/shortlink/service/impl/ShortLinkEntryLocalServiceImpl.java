...
import com.liferay.shortlink.ShortLinkEntryInvalidInputException;
...
public class ShortLinkEntryLocalServiceImpl
	 ...
	 *         link is already taken
	 */
	public ShortLinkEntry addShortLinkEntry(String originalURL, String shortURL)
		throws PortalException, SystemException {

		validate(originalURL, shortURL);

		return createNewShortLinkEntry(false, originalURL, shortURL);
	}
	...
	public ShortLinkEntry updateShortLinkEntryWithCheck(
		...
		ShortLinkEntry originalLink = getShortLinkEntry(shortLinkEntryId);
	...
	private ShortLinkEntry createNewShortLinkEntry(
			boolean autogenerated, String originalURL, String shortURL)
		throws SystemException {
	...
	private void validate(
		...
		if (shortLinkEntryId <= 0) {
			throw new ShortLinkEntryInvalidInputException(
				"short-link-entry-id-not-set");
		}

		validate(originalURL, shortURL);
	}

	private void validate(String originalURL) throws PortalException {
		if (Validator.isBlank(originalURL)) {
			throw new ShortLinkEntryInvalidInputException(
				"original-url-not-set");
		}
	}

	private void validate(String originalURL, String shortURL)
		throws PortalException, SystemException {

		validate(originalURL);

		if (Validator.isBlank(shortURL)) {
			throw new ShortLinkEntryInvalidInputException("short-url-not-set");
		}
