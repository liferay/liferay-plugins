...
/**
 * The utility for the short link entry local service. This utility wraps {@link com.liferay.shortlink.service.impl.ShortLinkEntryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class ShortLinkEntryLocalServiceUtil {
	...
	*/
	public static com.liferay.shortlink.model.ShortLinkEntry updateShortLinkEntry(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateShortLinkEntry(shortLinkEntry, merge);
	}
