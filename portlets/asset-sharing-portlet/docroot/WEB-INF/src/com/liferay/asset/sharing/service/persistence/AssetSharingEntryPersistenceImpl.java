...
public class AssetSharingEntryPersistenceImpl extends BasePersistenceImpl<AssetSharingEntry>
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					...
					list = new UnmodifiableList<AssetSharingEntry>(list);
				}
				else {
					list = (List<AssetSharingEntry>)QueryUtil.list(q,
	...
	public List<AssetSharingEntry> findByS_S(long sharedToClassNameId,
		long sharedToClassPK) throws SystemException {
	...
	@Override
	public List<AssetSharingEntry> findByS_S(long sharedToClassNameId,
		long sharedToClassPK, int start, int end) throws SystemException {
	...
	public AssetSharingEntry findByS_S_First(long sharedToClassNameId,
		long sharedToClassPK, OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
	...
	public List<AssetSharingEntry> findByC_C_S(long classNameId, long classPK,
		long sharedToClassNameId) throws SystemException {
	...
	@Override
	public List<AssetSharingEntry> findByC_C_S(long classNameId, long classPK,
		long sharedToClassNameId, int start, int end) throws SystemException {
	...
	public AssetSharingEntry findByC_C_S_First(long classNameId, long classPK,
		long sharedToClassNameId, OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
	...
	public void clearCache() {
		...
		EntityCacheUtil.clearCache(AssetSharingEntryImpl.class.getName());
	 ...
	 */
	@Override
	public List<AssetSharingEntry> findAll() throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.asset.sharing.model.AssetSharingEntry")));

		if (listenerClassNames.length > 0) {
			try {
				List<ModelListener<AssetSharingEntry>> listenersList = new ArrayList<ModelListener<AssetSharingEntry>>();

				for (String listenerClassName : listenerClassNames) {
					listenersList.add((ModelListener<AssetSharingEntry>)InstanceFactory.newInstance(
	...
	private static Log _log = LogFactoryUtil.getLog(AssetSharingEntryPersistenceImpl.class);
	private static AssetSharingEntry _nullAssetSharingEntry = new AssetSharingEntryImpl() {
			@Override
			public Object clone() {
				return this;
			}
	...
	private static CacheModel<AssetSharingEntry> _nullAssetSharingEntryCacheModel =
