...
<c:choose>
	...
	<c:otherwise>
		...
		%>
			...
			<tr>
				<td>
					<a href="<%= rowURL.toString() %>"><img align="left" border="0" src="<%= themeDisplay.getPathThemeImages() %>/file_system/small/<%= DLUtil.getFileIcon(fileEntry.getName()) %>.png" /><%= fileEntry.getTitle() %></a>
				</td>
			</tr>
