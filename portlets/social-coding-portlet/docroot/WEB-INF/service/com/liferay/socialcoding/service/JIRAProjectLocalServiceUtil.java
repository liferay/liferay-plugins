...
/**
 * The utility for the j i r a project local service. This utility wraps {@link com.liferay.socialcoding.service.impl.JIRAProjectLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class JIRAProjectLocalServiceUtil {
	...
	*/
	public static com.liferay.socialcoding.model.JIRAProject updateJIRAProject(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateJIRAProject(jiraProject, merge);
	}
