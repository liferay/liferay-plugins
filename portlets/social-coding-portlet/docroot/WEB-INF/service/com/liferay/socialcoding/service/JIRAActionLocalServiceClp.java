...
public class JIRAActionLocalServiceClp implements JIRAActionLocalService {
	public JIRAActionLocalServiceClp(String className,
	...
	private final MethodKey _addJIRAActionMethodKey0 = new MethodKey(_className,
			"addJIRAAction", com.liferay.socialcoding.model.JIRAAction.class);
	private final MethodKey _createJIRAActionMethodKey1 = new MethodKey(_className,
			"createJIRAAction", long.class);
	private final MethodKey _deleteJIRAActionMethodKey2 = new MethodKey(_className,
			"deleteJIRAAction", long.class);
	private final MethodKey _deleteJIRAActionMethodKey3 = new MethodKey(_className,
	...
	private final MethodKey _getJIRAActionMethodKey8 = new MethodKey(_className,
			"getJIRAAction", long.class);
	private final MethodKey _getJIRAActionsMethodKey9 = new MethodKey(_className,
			"getJIRAActions", int.class, int.class);
	private final MethodKey _getJIRAActionsCountMethodKey10 = new MethodKey(_className,
			"getJIRAActionsCount");
	private final MethodKey _updateJIRAActionMethodKey11 = new MethodKey(_className,
			"updateJIRAAction", com.liferay.socialcoding.model.JIRAAction.class);
	private final MethodKey _updateJIRAActionMethodKey12 = new MethodKey(_className,
			"updateJIRAAction",
