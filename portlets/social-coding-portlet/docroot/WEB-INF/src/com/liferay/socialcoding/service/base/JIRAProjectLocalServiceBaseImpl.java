...
/**
 * The base implementation of the j i r a project local service.
 *
 * <p>
...
public abstract class JIRAProjectLocalServiceBaseImpl
	...
	public JIRAProject addJIRAProject(JIRAProject jiraProject)
		...
		return jiraProjectPersistence.update(jiraProject, false);
	}
	...
	public JIRAProject updateJIRAProject(JIRAProject jiraProject)
		throws SystemException {
		return updateJIRAProject(jiraProject, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public JIRAProject updateJIRAProject(JIRAProject jiraProject, boolean merge)
		throws SystemException {
		jiraProject.setNew(false);

		return jiraProjectPersistence.update(jiraProject, merge);
	}
