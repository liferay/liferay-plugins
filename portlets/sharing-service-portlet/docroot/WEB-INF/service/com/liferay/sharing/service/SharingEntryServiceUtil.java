...
public class SharingEntryServiceUtil {
	...
	*/
	...
	public static SharingEntryService getService() {
		if (_service == null) {
			InvokableService invokableService = (InvokableService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					SharingEntryService.class.getName());

			if (invokableService instanceof SharingEntryService) {
				_service = (SharingEntryService)invokableService;
			}
			else {
				_service = new SharingEntryServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(SharingEntryServiceUtil.class,
				"_service");
		}
	 ...
	 */
	@Deprecated
	public void setService(SharingEntryService service) {
	}

	private static SharingEntryService _service;
}