...
<a href="<%= PortalUtil.getPathContext(request) %>/test_session/servlet_session_attributes">Servlet Session Attributes</a>
...
<a href="javascript:var viewChartWindow = window.open('<%= PortalUtil.getPathContext(request) %>/portlet_action/sample_struts_liferay_portlet/view_chart?chart_type=area', 'viewChart', 'directories=no,height=430,location=no,menubar=no,resizable=no,scrollbars=no,status=no,toolbar=no,width=420'); void(''); viewChartWindow.focus();">Area</a>
...
<a href="javascript:var viewChartWindow = window.open('<%= PortalUtil.getPathContext(request) %>/portlet_action/sample_struts_liferay_portlet/view_chart?chart_type=line', 'viewChart', 'directories=no,height=430,location=no,menubar=no,resizable=no,scrollbars=no,status=no,toolbar=no,width=420'); void(''); viewChartWindow.focus();">Line</a>

|

<a href="javascript:var viewChartWindow = window.open('<%= PortalUtil.getPathContext(request) %>/portlet_action/sample_struts_liferay_portlet/view_chart?chart_type=pie', 'viewChart', 'directories=no,height=430,location=no,menubar=no,resizable=no,scrollbars=no,status=no,toolbar=no,width=420'); void(''); viewChartWindow.focus();">Pie</a>
