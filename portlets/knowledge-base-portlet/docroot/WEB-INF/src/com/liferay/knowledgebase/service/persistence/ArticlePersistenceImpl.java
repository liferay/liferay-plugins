...
public class ArticlePersistenceImpl extends BasePersistenceImpl<Article>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_R_G = new FinderPath(ArticleModelImpl.ENTITY_CACHE_ENABLED,
			ArticleModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"findByR_G",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_R_G = new FinderPath(ArticleModelImpl.ENTITY_CACHE_ENABLED,
			ArticleModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"countByR_G",
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_R_G_L = new FinderPath(ArticleModelImpl.ENTITY_CACHE_ENABLED,
			ArticleModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"countByR_G_L",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_R_G_S = new FinderPath(ArticleModelImpl.ENTITY_CACHE_ENABLED,
			ArticleModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"countByR_G_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Article> findByR_G(long resourcePrimKey, long groupId)
		throws SystemException {
	...
	public List<Article> findByR_G(long resourcePrimKey, long groupId,
		...
		List<Article> list = (List<Article>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_R_G,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_R_G,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_R_G,
						finderArgs, list);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Article findByR_G_First(long resourcePrimKey, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		List<Article> list = findByR_G(resourcePrimKey, groupId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Article findByR_G_Last(long resourcePrimKey, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		int count = countByR_G(resourcePrimKey, groupId);

		List<Article> list = findByR_G(resourcePrimKey, groupId, count - 1,
				count, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Article[] findByR_G_PrevAndNext(long articleId,
		...
		try {
			...
			array[0] = getByR_G_PrevAndNext(session, article, resourcePrimKey,
					groupId, orderByComparator, true);

			array[1] = article;

			array[2] = getByR_G_PrevAndNext(session, article, resourcePrimKey,
	...
	protected Article getByR_G_PrevAndNext(Session session, Article article,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Article> filterFindByR_G(long resourcePrimKey, long groupId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Article[] filterFindByR_G_PrevAndNext(long articleId,
		long resourcePrimKey, long groupId, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByR_G_PrevAndNext(articleId, resourcePrimKey, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByR_G_PrevAndNext(session, article,
					resourcePrimKey, groupId, orderByComparator, true);

			array[1] = article;

			array[2] = filterGetByR_G_PrevAndNext(session, article,
	...
	protected Article filterGetByR_G_PrevAndNext(Session session,
	...
	public List<Article> findByR_G_L(long resourcePrimKey, long groupId,
		...
		List<Article> list = (List<Article>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_R_G_L,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_R_G_L,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_R_G_L,
						finderArgs, list);
				}
	...
	public Article findByR_G_L_Last(long resourcePrimKey, long groupId,
		...
		List<Article> list = findByR_G_L(resourcePrimKey, groupId, latest,
				count - 1, count, orderByComparator);
	...
	public Article[] findByR_G_L_PrevAndNext(long articleId,
		...
		try {
			...
			array[0] = getByR_G_L_PrevAndNext(session, article,
					resourcePrimKey, groupId, latest, orderByComparator, true);

			array[1] = article;

			array[2] = getByR_G_L_PrevAndNext(session, article,
	...
	public Article[] filterFindByR_G_L_PrevAndNext(long articleId,
		...
		throws NoSuchArticleException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByR_G_L_PrevAndNext(articleId, resourcePrimKey, groupId,
		...
		try {
			...
			array[0] = filterGetByR_G_L_PrevAndNext(session, article,
					resourcePrimKey, groupId, latest, orderByComparator, true);

			array[1] = article;

			array[2] = filterGetByR_G_L_PrevAndNext(session, article,
					resourcePrimKey, groupId, latest, orderByComparator, false);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Article> findByR_G_S(long resourcePrimKey, long groupId,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Article findByR_G_S_First(long resourcePrimKey, long groupId,
		int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		List<Article> list = findByR_G_S(resourcePrimKey, groupId, status, 0,
				1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Article findByR_G_S_Last(long resourcePrimKey, long groupId,
		int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		int count = countByR_G_S(resourcePrimKey, groupId, status);

		List<Article> list = findByR_G_S(resourcePrimKey, groupId, status,
				count - 1, count, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Article[] findByR_G_S_PrevAndNext(long articleId,
		...
		try {
			...
			array[0] = getByR_G_S_PrevAndNext(session, article,
					resourcePrimKey, groupId, status, orderByComparator, true);

			array[1] = article;

			array[2] = getByR_G_S_PrevAndNext(session, article,
	...
	protected Article getByR_G_S_PrevAndNext(Session session, Article article,
		long resourcePrimKey, long groupId, int status,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Article> filterFindByR_G_S(long resourcePrimKey, long groupId,
		int status) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Article[] filterFindByR_G_S_PrevAndNext(long articleId,
		long resourcePrimKey, long groupId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByR_G_S_PrevAndNext(articleId, resourcePrimKey, groupId,
		...
		try {
			...
			array[0] = filterGetByR_G_S_PrevAndNext(session, article,
					resourcePrimKey, groupId, status, orderByComparator, true);

			array[1] = article;

			array[2] = filterGetByR_G_S_PrevAndNext(session, article,
					resourcePrimKey, groupId, status, orderByComparator, false);
	...
	protected Article filterGetByR_G_S_PrevAndNext(Session session,
		Article article, long resourcePrimKey, long groupId, int status,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByR_G(long resourcePrimKey, long groupId)
		throws SystemException {
		for (Article article : findByR_G(resourcePrimKey, groupId)) {
			articlePersistence.remove(article);
		}
	}
	...
	public void removeByR_G_S(long resourcePrimKey, long groupId, int status)
		throws SystemException {
		for (Article article : findByR_G_S(resourcePrimKey, groupId, status)) {
			articlePersistence.remove(article);
		}
	}
	...
	private static final String _FINDER_COLUMN_R_G_RESOURCEPRIMKEY_2 = "article.resourcePrimKey = ? AND ";
	private static final String _FINDER_COLUMN_R_G_GROUPID_2 = "article.groupId = ?";
	...
	private static final String _FINDER_COLUMN_R_G_L_GROUPID_2 = "article.groupId = ? AND ";
