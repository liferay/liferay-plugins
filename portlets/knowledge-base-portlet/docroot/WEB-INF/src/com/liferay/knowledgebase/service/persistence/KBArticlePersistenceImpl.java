...
public class KBArticlePersistenceImpl extends BasePersistenceImpl<KBArticle>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_KBTEMPLATEID = new FinderPath(KBArticleModelImpl.ENTITY_CACHE_ENABLED,
			KBArticleModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"findByKBTemplateId",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_KBTEMPLATEID = new FinderPath(KBArticleModelImpl.ENTITY_CACHE_ENABLED,
			KBArticleModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"countByKBTemplateId", new String[] { Long.class.getName() });
	 ...
	 *
	 * @param primaryKey the primary key of the k b article to remove
	 ...
	 *
	 * @param kbArticle the k b article to remove
	 * @return the k b article that was removed
	 * @throws SystemException if a system exception occurred
	 */
	...
	protected KBArticle removeImpl(KBArticle kbArticle)
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_R_V,
			new Object[] {
				...
				Integer.valueOf(kbArticleModelImpl.getVersion())
			});
	...
	/**
	 * Finds the k b article with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the k b article to find
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<KBArticle> findByKBTemplateId(long kbTemplateId)
		throws SystemException {
		return findByKBTemplateId(kbTemplateId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<KBArticle> findByKBTemplateId(long kbTemplateId, int start,
		int end) throws SystemException {
		return findByKBTemplateId(kbTemplateId, start, end, null);
	}
	...
	public List<KBArticle> findByKBTemplateId(long kbTemplateId, int start,
		...
		List<KBArticle> list = (List<KBArticle>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_KBTEMPLATEID,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_KBTEMPLATEID_KBTEMPLATEID_2);
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_KBTEMPLATEID,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_KBTEMPLATEID,
						finderArgs, list);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KBArticle findByKBTemplateId_First(long kbTemplateId,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		List<KBArticle> list = findByKBTemplateId(kbTemplateId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KBArticle findByKBTemplateId_Last(long kbTemplateId,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		int count = countByKBTemplateId(kbTemplateId);

		List<KBArticle> list = findByKBTemplateId(kbTemplateId, count - 1,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KBArticle[] findByKBTemplateId_PrevAndNext(long kbArticleId,
		long kbTemplateId, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		KBArticle kbArticle = findByPrimaryKey(kbArticleId);
		...
		try {
			...
			array[0] = getByKBTemplateId_PrevAndNext(session, kbArticle,
					kbTemplateId, orderByComparator, true);

			array[1] = kbArticle;

			array[2] = getByKBTemplateId_PrevAndNext(session, kbArticle,
					kbTemplateId, orderByComparator, false);
	...
	protected KBArticle getByKBTemplateId_PrevAndNext(Session session,
		KBArticle kbArticle, long kbTemplateId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByKBTemplateId(long kbTemplateId)
		throws SystemException {
		for (KBArticle kbArticle : findByKBTemplateId(kbTemplateId)) {
			kbArticlePersistence.remove(kbArticle);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByKBTemplateId(long kbTemplateId) throws SystemException {
		Object[] finderArgs = new Object[] { kbTemplateId };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_KBTEMPLATEID,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_KBTEMPLATEID,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_KBTEMPLATEID_KBTEMPLATEID_2 = "kbArticle.kbTemplateId = ?";
