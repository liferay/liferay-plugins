...
public abstract class KBFolderLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	@Override
	public KBFolder addKBFolder(KBFolder kbFolder) throws SystemException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public KBFolder deleteKBFolder(KBFolder kbFolder) throws SystemException {
	 ...
	 */
	@Override
	public KBFolder fetchKBFolderByUuidAndCompanyId(String uuid, long companyId)
		throws SystemException {
		return kbFolderPersistence.fetchByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public KBFolder getKBFolderByUuidAndCompanyId(String uuid, long companyId)
		throws PortalException, SystemException {
		return kbFolderPersistence.findByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public int getKBFoldersCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public KBFolder updateKBFolder(KBFolder kbFolder) throws SystemException {
		return kbFolderPersistence.update(kbFolder);
	}
