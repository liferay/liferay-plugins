...
public class KBStructurePersistenceImpl extends BasePersistenceImpl<KBStructure>
	 ...
	 *
	 * @param primaryKey the primary key of the k b structure to remove
	 ...
	 *
	 * @param kbStructure the k b structure to remove
	 * @return the k b structure that was removed
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Finds the k b structure with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the k b structure to find
	...
	/**
	 * Filters by the user's permissions and finds all the k b structures where groupId = &#63;.
	 *
	 * @param groupId the group ID to search with
	 * @return the matching k b structures that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	public List<KBStructure> filterFindByGroupId(long groupId)
		throws SystemException {
	...
	/**
	 * Filters by the user's permissions and finds a range of all the k b structures where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @param start the lower bound of the range of k b structures to return
	 * @param end the upper bound of the range of k b structures to return (not inclusive)
	 * @return the range of matching k b structures that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	public List<KBStructure> filterFindByGroupId(long groupId, int start,
		int end) throws SystemException {
		return filterFindByGroupId(groupId, start, end, null);
	}

	/**
	 * Filters by the user's permissions and finds an ordered range of all the k b structures where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @param end the upper bound of the range of k b structures to return (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	 * @return the ordered range of matching k b structures that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	public List<KBStructure> filterFindByGroupId(long groupId, int start,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_KBSTRUCTURE_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_KBSTRUCTURE_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_KBSTRUCTURE_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(KBStructureModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, KBStructureImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, KBStructureImpl.class);
			}
			...
			return (List<KBStructure>)QueryUtil.list(q, getDialect(), start, end);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	/**
	 * Filters the k b structures before and after the current k b structure in the ordered set where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KBStructure[] filterFindByGroupId_PrevAndNext(long kbStructureId,
		long groupId, OrderByComparator orderByComparator)
		throws NoSuchStructureException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(kbStructureId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, kbStructure,
					groupId, orderByComparator, true);

			array[1] = kbStructure;

			array[2] = filterGetByGroupId_PrevAndNext(session, kbStructure,
	...
	protected KBStructure filterGetByGroupId_PrevAndNext(Session session,
		KBStructure kbStructure, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Filters by the user's permissions and counts all the k b structures where groupId = &#63;.
	 *
	 * @param groupId the group ID to search with
	 * @return the number of matching k b structures that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	public int filterCountByGroupId(long groupId) throws SystemException {
		...
		query.append(_FILTER_SQL_COUNT_KBSTRUCTURE_WHERE);
	...
	private static final String _FILTER_SQL_SELECT_KBSTRUCTURE_WHERE = "SELECT DISTINCT {kbStructure.*} FROM KBStructure kbStructure WHERE ";
	private static final String _FILTER_SQL_SELECT_KBSTRUCTURE_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {KBStructure.*} FROM (SELECT DISTINCT kbStructure.kbStructureId FROM KBStructure kbStructure WHERE ";
	private static final String _FILTER_SQL_SELECT_KBSTRUCTURE_NO_INLINE_DISTINCT_WHERE_2 =
	...
	private static final String _ORDER_BY_ENTITY_TABLE = "KBStructure.";
