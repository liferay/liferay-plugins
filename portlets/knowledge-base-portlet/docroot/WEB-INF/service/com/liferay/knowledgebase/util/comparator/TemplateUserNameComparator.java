 ...
 */
public class TemplateUserNameComparator extends OrderByComparator {
	...
	public TemplateUserNameComparator() {
		this(false);
	}

	public TemplateUserNameComparator(boolean ascending) {
	...
	public int compare(Object obj1, Object obj2) {
		...
		int value = template1.getUserName().toLowerCase().compareTo(
			template2.getUserName().toLowerCase());
