...
create index IX_75F60464 on KB_KBArticle (companyId, head, template, draft);
...
create index IX_D0E6B89D on KB_KBArticle (parentResourcePrimKey, draft);
create index IX_572BD3C8 on KB_KBArticle (parentResourcePrimKey, head);
create index IX_4C680749 on KB_KBArticle (parentResourcePrimKey, head, draft);
create index IX_EC3B689B on KB_KBArticle (parentResourcePrimKey, head, template, draft);
