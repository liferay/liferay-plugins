...
<div class="kb-template-tools">
	...
	<tr>
		<td>
			...
			<%
			String taglibURL = "javascript:var printTemplateWindow = window.open('" + printURL + "', 'printTemplate', 'directories=no,height=640,location=no,menubar=no,resizable=yes,scrollbars=yes,status=no,toolbar=no,width=680'); void(''); printTemplateWindow.focus();";
			%>
