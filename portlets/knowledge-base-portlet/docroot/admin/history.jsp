	...
	<aui:fieldset>
		...
		>
			<liferay-ui:search-container-results
				results="<%= ArticleServiceUtil.getArticleVersions(scopeGroupId, article.getResourcePrimKey(), status, searchContainer.getStart(), searchContainer.getEnd(), new ArticleVersionComparator()) %>"
				total="<%= ArticleServiceUtil.getArticleVersionsCount(scopeGroupId, article.getResourcePrimKey(), status) %>"
			/>
