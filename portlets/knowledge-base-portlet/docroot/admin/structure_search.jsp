...
<%
KBStructureSearch searchContainer = (KBStructureSearch)request.getAttribute("liferay-ui:search:searchContainer");

KBStructureDisplayTerms displayTerms = (KBStructureDisplayTerms)searchContainer.getDisplayTerms();
%>

<liferay-ui:search-toggle
	buttonLabel="search"
	displayTerms="<%= displayTerms %>"
	id="toggle_id_knowledge_base_structure_search"
>
	<aui:fieldset cssClass="kb-block-labels kb-search-toggle">
		...
		<aui:field-wrapper cssClass="float-container kb-field-wrapper" label="date">
			...
			<span class='<%= displayTerms.isAnytime() ? "yui3-aui-helper-hidden kb-date-field" : "kb-date-field" %>' id="<portlet:namespace />datesOptions">
