...
KBComment kbComment = (KBComment)request.getAttribute("structure_comment.jsp-kb_comment");
%>

<div class="kb-structure-comment">
	...
	<tr>
		...
		<td valign="top" width="99%">
			...
			<c:if test="<%= (user.getUserId() == kbComment.getUserId()) || KBStructurePermission.contains(permissionChecker, kbStructure, ActionKeys.UPDATE) %>">
				<br />
