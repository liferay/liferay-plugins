...
public class TasksEntryServiceClp implements TasksEntryService {
	public TasksEntryServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addTasksEntryMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addTasksEntry", java.lang.String.class, int.class, long.class,
				int.class, int.class, int.class, int.class, int.class,
				boolean.class, com.liferay.portal.service.ServiceContext.class);

		_getTasksEntryMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"getTasksEntry", long.class);

		_updateTasksEntryMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
	...
	public com.liferay.tms.model.TasksEntry addTasksEntry(
		...
		MethodHandler methodHandler = new MethodHandler(_addTasksEntryMethodKey0,
				ClpSerializer.translateInput(title), priority, assigneeUserId,
				dueDateMonth, dueDateDay, dueDateYear, dueDateHour,
				dueDateMinute, neverDue,
	...
	public com.liferay.tms.model.TasksEntry getTasksEntry(long tasksEntryId)
		...
		MethodHandler methodHandler = new MethodHandler(_getTasksEntryMethodKey1,
				tasksEntryId);
	...
	public com.liferay.tms.model.TasksEntry updateTasksEntry(
		...
		MethodHandler methodHandler = new MethodHandler(_updateTasksEntryMethodKey2,
	...
	private MethodKey _getTasksEntryMethodKey1;
	private MethodKey _updateTasksEntryMethodKey2;
}