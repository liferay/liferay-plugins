 ...
 * @author Peter Shin
 */
public class SubscriptionCreateDateComparator extends OrderByComparator {
	...
	public SubscriptionCreateDateComparator() {
		this(false);
	}

	public SubscriptionCreateDateComparator(boolean ascending) {
	...
	public int compare(Object obj1, Object obj2) {
		...
		int value = DateUtil.compareTo(
			subscription1.getCreateDate(), subscription2.getCreateDate());
