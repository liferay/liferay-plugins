...
public class ModuleLocalServiceClp implements ModuleLocalService {
	public ModuleLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addModuleMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addModule", com.liferay.marketplace.model.Module.class);

		_createModuleMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createModule", long.class);

		_deleteModuleMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteModule", long.class);

		_deleteModuleMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteModule", com.liferay.marketplace.model.Module.class);
	...
	public com.liferay.marketplace.model.Module addModule(
		...
		MethodHandler methodHandler = new MethodHandler(_addModuleMethodKey0,
	...
	public com.liferay.marketplace.model.Module createModule(long moduleId) {
		...
		MethodHandler methodHandler = new MethodHandler(_createModuleMethodKey1,
				moduleId);
	...
	private MethodKey _addModuleMethodKey0;
	private MethodKey _createModuleMethodKey1;
	private MethodKey _deleteModuleMethodKey2;
	private MethodKey _deleteModuleMethodKey3;
