...
public class AppLocalServiceClp implements AppLocalService {
	public AppLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addAppMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addApp", com.liferay.marketplace.model.App.class);

		_createAppMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createApp", long.class);

		_deleteAppMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteApp", long.class);

		_deleteAppMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteApp", com.liferay.marketplace.model.App.class);
	...
	public com.liferay.marketplace.model.App createApp(long appId) {
		...
		MethodHandler methodHandler = new MethodHandler(_createAppMethodKey1,
				appId);
	...
	private MethodKey _createAppMethodKey1;
	private MethodKey _deleteAppMethodKey2;
	private MethodKey _deleteAppMethodKey3;
