...
create table HRAssetDefinition (
	...
	modifiedDate DATE null,
	hrAssetTypeId LONG,
	hrAssetModelId VARCHAR(75) null,
...
create table HRAssetModelId (
	hrAssetModelId LONG not null primary key,
	groupId LONG,
	companyId LONG,
	userId LONG,
	userName VARCHAR(75) null,
...
create table HRTimeSheetHoursPerDay (
	hrTimeSheetHoursPerDay LONG not null primary key,
	groupId LONG,
	companyId LONG,
	userId LONG,
	userName VARCHAR(75) null,
