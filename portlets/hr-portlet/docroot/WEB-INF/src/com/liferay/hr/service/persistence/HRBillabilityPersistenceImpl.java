...
public class HRBillabilityPersistenceImpl extends BasePersistenceImpl<HRBillability>
	 ...
	 *
	 * @param primaryKey the primary key of the h r billability to remove
	 ...
	 *
	 * @param hrBillability the h r billability to remove
	 * @return the h r billability that was removed
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Finds the h r billability with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the h r billability to find
