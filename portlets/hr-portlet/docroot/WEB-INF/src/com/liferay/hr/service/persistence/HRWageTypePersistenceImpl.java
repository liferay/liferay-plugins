...
public class HRWageTypePersistenceImpl extends BasePersistenceImpl<HRWageType>
	 ...
	 *
	 * @param primaryKey the primary key of the h r wage type to remove
	 ...
	 *
	 * @param hrWageType the h r wage type to remove
	 * @return the h r wage type that was removed
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Finds the h r wage type with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the h r wage type to find
