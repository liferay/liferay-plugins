...
public class HRTimeSheetHoursPerDayPersistenceImpl extends BasePersistenceImpl<HRTimeSheetHoursPerDay>
	 ...
	 */
	public HRTimeSheetHoursPerDay create(long hrTimeSheetHoursPerDay) {
		HRTimeSheetHoursPerDay hrTimeSheetHoursPerDay = new HRTimeSheetHoursPerDayImpl();

		hrTimeSheetHoursPerDay.setNew(true);
		hrTimeSheetHoursPerDay.setPrimaryKey(hrTimeSheetHoursPerDay);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HRTimeSheetHoursPerDay remove(long hrTimeSheetHoursPerDay)
		...
		try {
			...
			HRTimeSheetHoursPerDay hrTimeSheetHoursPerDay = (HRTimeSheetHoursPerDay)session.get(HRTimeSheetHoursPerDayImpl.class,
					Long.valueOf(hrTimeSheetHoursPerDay));

			if (hrTimeSheetHoursPerDay == null) {
				if (_log.isWarnEnabled()) {
					_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
						hrTimeSheetHoursPerDay);
				}
	...
	protected HRTimeSheetHoursPerDay toUnwrappedModel(
		...
		hrTimeSheetHoursPerDayImpl.setHrTimeSheetHoursPerDay(hrTimeSheetHoursPerDay.getHrTimeSheetHoursPerDay());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HRTimeSheetHoursPerDay findByPrimaryKey(long hrTimeSheetHoursPerDay)
		throws NoSuchTimeSheetHoursPerDayException, SystemException {
		HRTimeSheetHoursPerDay hrTimeSheetHoursPerDay = fetchByPrimaryKey(hrTimeSheetHoursPerDay);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HRTimeSheetHoursPerDay fetchByPrimaryKey(long hrTimeSheetHoursPerDay)
		throws SystemException {
		HRTimeSheetHoursPerDay hrTimeSheetHoursPerDay = (HRTimeSheetHoursPerDay)EntityCacheUtil.getResult(HRTimeSheetHoursPerDayModelImpl.ENTITY_CACHE_ENABLED,
				HRTimeSheetHoursPerDayImpl.class, hrTimeSheetHoursPerDay, this);
