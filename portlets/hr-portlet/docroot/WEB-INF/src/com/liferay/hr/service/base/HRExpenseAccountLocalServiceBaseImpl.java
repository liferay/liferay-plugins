...
/**
 * The base implementation of the h r expense account local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.hr.service.impl.HRExpenseAccountLocalServiceImpl}.
 * </p>
 *
 * @author Wesley Gong
 * @see com.liferay.hr.service.impl.HRExpenseAccountLocalServiceImpl
 * @see com.liferay.hr.service.HRExpenseAccountLocalServiceUtil
 * @generated
 */
public abstract class HRExpenseAccountLocalServiceBaseImpl
	implements HRExpenseAccountLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.hr.service.HRExpenseAccountLocalServiceUtil} to access the h r expense account local service.
	 */
	 ...
	 */
	public HRExpenseAccount addHRExpenseAccount(
		HRExpenseAccount hrExpenseAccount) throws SystemException {
		hrExpenseAccount.setNew(true);

		hrExpenseAccount = hrExpenseAccountPersistence.update(hrExpenseAccount,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(hrExpenseAccount);
			}
	 ...
	 */
	public HRExpenseAccount createHRExpenseAccount(long hrExpenseAccountId) {
		return hrExpenseAccountPersistence.create(hrExpenseAccountId);
	}
	...
	public void deleteHRExpenseAccount(long hrExpenseAccountId)
		...
		HRExpenseAccount hrExpenseAccount = hrExpenseAccountPersistence.remove(hrExpenseAccountId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(hrExpenseAccount);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteHRExpenseAccount(HRExpenseAccount hrExpenseAccount)
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return hrExpenseAccountPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return hrExpenseAccountPersistence.countWithDynamicQuery(dynamicQuery);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<HRExpenseAccount> getHRExpenseAccounts(int start, int end)
		throws SystemException {
		return hrExpenseAccountPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getHRExpenseAccountsCount() throws SystemException {
		return hrExpenseAccountPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HRExpenseAccount updateHRExpenseAccount(
		HRExpenseAccount hrExpenseAccount) throws SystemException {
		return updateHRExpenseAccount(hrExpenseAccount, true);
	}
	 ...
	 */
	public HRExpenseAccount updateHRExpenseAccount(
		HRExpenseAccount hrExpenseAccount, boolean merge)
		throws SystemException {
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = hrExpenseAccountPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(HRExpenseAccountLocalServiceBaseImpl.class);
