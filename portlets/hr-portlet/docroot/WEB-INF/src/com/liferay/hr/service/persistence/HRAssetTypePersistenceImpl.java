...
public class HRAssetTypePersistenceImpl extends BasePersistenceImpl<HRAssetType>
	 ...
	 *
	 * @param primaryKey the primary key of the h r asset type to remove
	 ...
	 *
	 * @param hrAssetType the h r asset type to remove
	 * @return the h r asset type that was removed
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Finds the h r asset type with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the h r asset type to find
