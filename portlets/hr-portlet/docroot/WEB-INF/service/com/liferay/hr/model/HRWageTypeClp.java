 ...
 * @author Wesley Gong
 */
public class HRWageTypeClp extends BaseModelImpl<HRWageType>
	implements HRWageType {
	public HRWageTypeClp() {
	}
	...
	public HRWageType toEscapedModel() {
		if (isEscapedModel()) {
			...
			return (HRWageType)Proxy.newProxyInstance(HRWageType.class.getClassLoader(),
				new Class[] { HRWageType.class },
	...
	@Override
	public Object clone() {
		HRWageTypeClp clone = new HRWageTypeClp();
	...
	public boolean equals(Object obj) {
		...
		HRWageTypeClp hrWageType = null;

		try {
			hrWageType = (HRWageTypeClp)obj;
		}
