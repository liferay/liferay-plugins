 ...
 */
public class HRProjectStatusClp extends BaseModelImpl<HRProjectStatus>
	implements HRProjectStatus {
	public HRProjectStatusClp() {
	}
	...
	public HRProjectStatus toEscapedModel() {
		if (isEscapedModel()) {
			...
			return (HRProjectStatus)Proxy.newProxyInstance(HRProjectStatus.class.getClassLoader(),
				new Class[] { HRProjectStatus.class },
	...
	public int compareTo(HRProjectStatus hrProjectStatus) {
		long pk = hrProjectStatus.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		HRProjectStatusClp hrProjectStatus = null;

		try {
			hrProjectStatus = (HRProjectStatusClp)obj;
		}
