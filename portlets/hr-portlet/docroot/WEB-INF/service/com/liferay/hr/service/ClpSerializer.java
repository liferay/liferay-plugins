...
import com.liferay.hr.model.HRAssetModelIdClp;
import com.liferay.hr.model.HRAssetTypeClp;
import com.liferay.hr.model.HRAssetVendorIdClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(HRAssetModelIdClp.class.getName())) {
			return translateInputHRAssetModelId(oldModel);
		}
		...
		if (oldModelClassName.equals(HRAssetVendorIdClp.class.getName())) {
			return translateInputHRAssetVendorId(oldModel);
		}
	...
	public static Object translateInputHRAssetDefinition(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				...
				Method method7 = newModelClass.getMethod("setHrAssetTypeId",
						new Class[] { Long.TYPE });

				Long value7 = new Long(oldCplModel.getHrAssetTypeId());

				method7.invoke(newModel, value7);

				Method method8 = newModelClass.getMethod("setHrAssetModelId",
						new Class[] { String.class });

				String value8 = oldCplModel.getHrAssetModelId();
	...
	public static Object translateInputHRAssetModelId(BaseModel<?> oldModel) {
		HRAssetModelIdClp oldCplModel = (HRAssetModelIdClp)oldModel;
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("com.liferay.hr.model.impl.HRAssetModelIdImpl",
						true, _classLoader);

				Object newModel = newModelClass.newInstance();

				Method method0 = newModelClass.getMethod("setHrAssetModelId",
						new Class[] { Long.TYPE });

				Long value0 = new Long(oldCplModel.getHrAssetModelId());
	...
	public static Object translateInputHRAssetVendorId(BaseModel<?> oldModel) {
		HRAssetVendorIdClp oldCplModel = (HRAssetVendorIdClp)oldModel;
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("com.liferay.hr.model.impl.HRAssetVendorIdImpl",
						true, _classLoader);
	...
	public static Object translateInputHRTimeSheetHoursPerDay(
		...
		try {
			...
			try {
				...
				Method method0 = newModelClass.getMethod("setHrTimeSheetHoursPerDay",
						new Class[] { Long.TYPE });

				Long value0 = new Long(oldCplModel.getHrTimeSheetHoursPerDay());
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.liferay.hr.model.impl.HRAssetModelIdImpl")) {
			return translateOutputHRAssetModelId(oldModel);
		}
		...
		if (oldModelClassName.equals(
					"com.liferay.hr.model.impl.HRAssetVendorIdImpl")) {
			return translateOutputHRAssetVendorId(oldModel);
		}
	...
	public static Object translateOutputHRAssetDefinition(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				...
				Method method7 = oldModelClass.getMethod("getHrAssetTypeId");

				Long value7 = (Long)method7.invoke(oldModel, (Object[])null);

				newModel.setHrAssetTypeId(value7);

				Method method8 = oldModelClass.getMethod("getHrAssetModelId");

				String value8 = (String)method8.invoke(oldModel, (Object[])null);

				newModel.setHrAssetModelId(value8);
	...
	public static Object translateOutputHRAssetModelId(BaseModel<?> oldModel) {
		Thread currentThread = Thread.currentThread();
		...
		try {
			...
			try {
				HRAssetModelIdClp newModel = new HRAssetModelIdClp();

				Class<?> oldModelClass = oldModel.getClass();

				Method method0 = oldModelClass.getMethod("getHrAssetModelId");

				Long value0 = (Long)method0.invoke(oldModel, (Object[])null);

				newModel.setHrAssetModelId(value0);
	...
	public static Object translateOutputHRAssetVendorId(BaseModel<?> oldModel) {
		Thread currentThread = Thread.currentThread();
		...
		try {
			...
			try {
				HRAssetVendorIdClp newModel = new HRAssetVendorIdClp();
	...
	public static Object translateOutputHRTimeSheetHoursPerDay(
		...
		try {
			...
			try {
				...
				Method method0 = oldModelClass.getMethod(
						"getHrTimeSheetHoursPerDay");

				Long value0 = (Long)method0.invoke(oldModel, (Object[])null);

				newModel.setHrTimeSheetHoursPerDay(value0);
