 ...
 * @generated
 */
public class HRTimeOffSoap implements Serializable {
	public static HRTimeOffSoap toSoapModel(HRTimeOff model) {
		HRTimeOffSoap soapModel = new HRTimeOffSoap();

		soapModel.setHrTimeOffId(model.getHrTimeOffId());
		...
		soapModel.setTotalHours(model.getTotalHours());
	...
	public static HRTimeOffSoap[] toSoapModels(HRTimeOff[] models) {
		HRTimeOffSoap[] soapModels = new HRTimeOffSoap[models.length];
	...
	public static HRTimeOffSoap[][] toSoapModels(HRTimeOff[][] models) {
		HRTimeOffSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new HRTimeOffSoap[models.length][models[0].length];
		}
		else {
			soapModels = new HRTimeOffSoap[0][0];
		}
	...
	public static HRTimeOffSoap[] toSoapModels(List<HRTimeOff> models) {
		List<HRTimeOffSoap> soapModels = new ArrayList<HRTimeOffSoap>(models.size());

		for (HRTimeOff model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new HRTimeOffSoap[soapModels.size()]);
	}

	public HRTimeOffSoap() {
	}
