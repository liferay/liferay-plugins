 ...
 * @author Wesley Gong
 */
public class HRBillabilityClp extends BaseModelImpl<HRBillability>
	implements HRBillability {
	public HRBillabilityClp() {
	}
	...
	public HRBillability toEscapedModel() {
		if (isEscapedModel()) {
			...
			return (HRBillability)Proxy.newProxyInstance(HRBillability.class.getClassLoader(),
				new Class[] { HRBillability.class },
				new AutoEscapeBeanHandler(this));
		}
	}

	public Object clone() {
		HRBillabilityClp clone = new HRBillabilityClp();
	...
	public boolean equals(Object obj) {
		...
		HRBillabilityClp hrBillability = null;

		try {
			hrBillability = (HRBillabilityClp)obj;
		}
