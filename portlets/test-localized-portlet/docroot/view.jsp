...
if (locale.getLanguage().equals("fr")) {
	expectedResourceBundleValues = new String[] {
		...
		"not.localized.hook",
		"This is an unlocalized portlet string.",
		"post",
		"post[adjective]",
		"post[noun]",
		"post[verb]",
	...
	expectedTaglibValues = new String[] {
		...
		"Veuillez prendre une boisson fra\u00eeche.",
		"This is an unlocalized hook string.",
		"This is an unlocalized portlet string.",
		"Envoyer",
		"Envoyer",
		"Envoyer",
...
String[][] tests = new String[][] {
	...
	new String[] {"Add a new unlocalized language entry from a hook.", "not.localized.hook"},
	new String[] {"Add a new unlocalized language entry from a portlet.", "not.localized.portlet"},
