...
boolean defaultIsoTimeFormat = !DateUtil.isFormatAmPm(locale);
boolean isoTimeFormat = GetterUtil.getBoolean(portletPreferences.getValue("isoTimeFormat", null), defaultIsoTimeFormat);
