...
public abstract class CalendarEventLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CalendarEventLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public CalendarEvent deleteCalendarEvent(long calendarEventId)
		...
		return calendarEventPersistence.remove(calendarEventId);
	}
	...
	public DynamicQuery dynamicQuery() {
		return DynamicQueryFactoryUtil.forClass(CalendarEvent.class,
			getClassLoader());
	}
	...
	private CalendarEventLocalServiceClpInvoker _clpInvoker = new CalendarEventLocalServiceClpInvoker();
}