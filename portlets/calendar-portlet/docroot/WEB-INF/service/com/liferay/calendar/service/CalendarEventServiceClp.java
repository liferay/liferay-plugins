...
public class CalendarEventServiceClp implements CalendarEventService {
	public CalendarEventServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addCaledarEventMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addCaledarEvent", java.util.Map.class, java.util.Map.class,
		...
		_deleteCalendarEventMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteCalendarEvent", long.class);

		_getCalendarEventMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"getCalendarEvent", long.class);

		_updateCalendarEventMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
	...
	public com.liferay.calendar.model.CalendarEvent addCaledarEvent(
		...
		MethodHandler methodHandler = new MethodHandler(_addCaledarEventMethodKey0,
	...
	public void deleteCalendarEvent(long calendarEventId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteCalendarEventMethodKey1,
				calendarEventId);
	...
	public com.liferay.calendar.model.CalendarEvent getCalendarEvent(
		...
		MethodHandler methodHandler = new MethodHandler(_getCalendarEventMethodKey2,
				calendarEventId);
	...
	public com.liferay.calendar.model.CalendarEvent updateCalendarEvent(
		...
		MethodHandler methodHandler = new MethodHandler(_updateCalendarEventMethodKey3,
	...
	private MethodKey _addCaledarEventMethodKey0;
	private MethodKey _deleteCalendarEventMethodKey1;
	private MethodKey _getCalendarEventMethodKey2;
	private MethodKey _updateCalendarEventMethodKey3;
}