...
public interface FooPersistence extends BasePersistence<Foo> {
	 ...
	 * @return the matching foos
	 */
	public java.util.List<Foo> findByField1(String field1);
	 ...
	 * @return the range of matching foos
	 */
	public java.util.List<Foo> findByField1(String field1, int start, int end);
	 ...
	 * @return the ordered range of matching foos
	 */
	public java.util.List<Foo> findByField1(
	 ...
	 * @return the matching foos
	 */
	public java.util.List<Foo> findByField1(String[] field1s);
