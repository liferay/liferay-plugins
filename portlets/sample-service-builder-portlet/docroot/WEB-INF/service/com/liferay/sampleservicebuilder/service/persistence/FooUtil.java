...
public class FooUtil {
	 ...
	 * @return the matching foos
	 */
	public static List<Foo> findByField1(String field1) {
	 ...
	 * @return the range of matching foos
	 */
	public static List<Foo> findByField1(String field1, int start, int end) {
	 ...
	 * @return the ordered range of matching foos
	 */
	public static List<Foo> findByField1(
		String field1, int start, int end,
		OrderByComparator<Foo> orderByComparator) {

		return getPersistence().findByField1(
			field1, start, end, orderByComparator);
	}
	...
	public static List<Foo> findByField1(
		...
		return getPersistence().findByField1(
			field1, start, end, orderByComparator, retrieveFromCache);
	}
	 ...
	 * @throws NoSuchFooException if a matching foo could not be found
	 */
	public static Foo findByField1_First(
	 ...
	 * @return the first matching foo, or <code>null</code> if a matching foo could not be found
	 */
	public static Foo fetchByField1_First(
		String field1, OrderByComparator<Foo> orderByComparator) {
	 ...
	 * @throws NoSuchFooException if a matching foo could not be found
	 */
	public static Foo findByField1_Last(
			String field1, OrderByComparator<Foo> orderByComparator)
		throws com.liferay.sampleservicebuilder.exception.NoSuchFooException {
	 ...
	 * @return the last matching foo, or <code>null</code> if a matching foo could not be found
	 */
	public static Foo fetchByField1_Last(
		String field1, OrderByComparator<Foo> orderByComparator) {
	 ...
	 * @return the matching foos
	 */
	public static List<Foo> findByField1(String[] field1s) {
	 ...
	 * @return the range of matching foos
	 */
	public static List<Foo> findByField1(String[] field1s, int start, int end) {
	...
	public static List<Foo> findByField1(
		...
		return getPersistence().findByField1(
			field1s, start, end, orderByComparator);
	}
	...
	public static List<Foo> findByField1(
		...
		return getPersistence().findByField1(
			field1s, start, end, orderByComparator, retrieveFromCache);
	}
	 ...
	 * @return the number of matching foos
	 */
	public static int countByField1(String[] field1s) {
	...
	public static FooPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FooPersistence)PortletBeanLocatorUtil.locate(
				com.liferay.sampleservicebuilder.service.ServletContextUtil.
