...
>
	...
	<div>
		...
		<span>
			<input type="button" value="<liferay-ui:message key="refresh-gadgets" />" onClick="location.href = '<portlet:actionURL name="refreshGadgets"><portlet:param name="redirect" value="<%= currentURL %>" /></portlet:actionURL>';" />
		</span>
	</div>
