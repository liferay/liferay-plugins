...
"gadgets.osDataUri" : "http://%host%/opensocial-portlet/social/rpc",
...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "http://%host%/opensocial-portlet/gadgets/proxy?refresh=%refresh%&url=%url%%rewriteMime%",
    "jsonProxyUrl" : "http://%host%/opensocial-portlet/gadgets/makeRequest"
  },
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "http://%host%/opensocial-portlet/opensocial-portlet/gadgets/profile?{var}",
  ...
  "rpc" : {
    ...
    "parentRelayUrl" : "/opensocial-portlet/gadgets/files/container/rpc_relay.html",
  ...
  "opensocial" : {
    ...
    "path" : "http://%host%/opensocial-portlet/social/rpc",
    // Path to issue invalidate calls
    "invalidatePath" : "http://%host%/opensocial-portlet/gadgets/api/rpc",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
  ...
  "osapi" : {
    ...
    "endPoints" : [ "http://%host%/opensocial-portlet/social/rpc", "http://%host%/opensocial-portlet/gadgets/api/rpc" ]                   
  },
  "osml": {
