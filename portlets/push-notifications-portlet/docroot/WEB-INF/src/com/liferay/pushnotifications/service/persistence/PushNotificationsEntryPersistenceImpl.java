...
public class PushNotificationsEntryPersistenceImpl extends BasePersistenceImpl<PushNotificationsEntry>
	...
	public List<PushNotificationsEntry> findByParentPushNotificationsEntryId(
		long parentPushNotificationsEntryId) throws SystemException {
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					...
					list = new UnmodifiableList<PushNotificationsEntry>(list);
				}
				else {
					list = (List<PushNotificationsEntry>)QueryUtil.list(q,
	...
	public PushNotificationsEntry findByParentPushNotificationsEntryId_First(
		long parentPushNotificationsEntryId, OrderByComparator orderByComparator)
	...
	public void clearCache() {
		...
		EntityCacheUtil.clearCache(PushNotificationsEntryImpl.class.getName());
	...
	public PushNotificationsEntry fetchByPrimaryKey(
		long pushNotificationsEntryId) throws SystemException {
	 ...
	 */
	@Override
	public List<PushNotificationsEntry> findAll() throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.pushnotifications.model.PushNotificationsEntry")));

		if (listenerClassNames.length > 0) {
			try {
				List<ModelListener<PushNotificationsEntry>> listenersList = new ArrayList<ModelListener<PushNotificationsEntry>>();

				for (String listenerClassName : listenerClassNames) {
					listenersList.add((ModelListener<PushNotificationsEntry>)InstanceFactory.newInstance(
	...
	private static Log _log = LogFactoryUtil.getLog(PushNotificationsEntryPersistenceImpl.class);
	private static PushNotificationsEntry _nullPushNotificationsEntry = new PushNotificationsEntryImpl() {
			@Override
			public Object clone() {
				return this;
			}
	...
	private static CacheModel<PushNotificationsEntry> _nullPushNotificationsEntryCacheModel =
