...
public class ApplePushNotificationsSender implements PushNotificationsSender {
	...
	public String getCertificatePassword() throws SystemException {
	...
	public String getCertificatePath() throws SystemException {
	...
	public boolean isSandbox() throws SystemException {
		if (_sandbox == null) {
	...
	protected String buildPayload(JSONObject payloadJSONObject) {
		...
		if (bodyLocalizedArgumentsJSONArray != null) {
			List<String> localizedArguments = new ArrayList<String>();
