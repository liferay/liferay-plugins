...
import com.liferay.samplealloymvc.service.SAMTodoListLocalService;
...
/**
 * Provides the base implementation for the s a m todo list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.samplealloymvc.service.impl.SAMTodoListLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.samplealloymvc.service.impl.SAMTodoListLocalServiceImpl
 * @see com.liferay.samplealloymvc.service.SAMTodoListLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class SAMTodoListLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SAMTodoListLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.samplealloymvc.service.SAMTodoListLocalServiceUtil} to access the s a m todo list local service.
	 */
	...
	public SAMTodoList addSAMTodoList(SAMTodoList samTodoList) {
		...
		return samTodoListPersistence.update(samTodoList);
	}
	...
	public SAMTodoList createSAMTodoList(long samTodoListId) {
		return samTodoListPersistence.create(samTodoListId);
	}
	...
	public SAMTodoList deleteSAMTodoList(long samTodoListId)
		...
		return samTodoListPersistence.remove(samTodoListId);
	}
	...
	public SAMTodoList deleteSAMTodoList(SAMTodoList samTodoList) {
		return samTodoListPersistence.remove(samTodoList);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SAMTodoList.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return samTodoListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return samTodoListPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return samTodoListPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SAMTodoList fetchSAMTodoList(long samTodoListId) {
		return samTodoListPersistence.fetchByPrimaryKey(samTodoListId);
	}
	...
	public SAMTodoList getSAMTodoList(long samTodoListId)
		throws PortalException {
		return samTodoListPersistence.findByPrimaryKey(samTodoListId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(samTodoListLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SAMTodoList.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("samTodoListId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(samTodoListLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SAMTodoList.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return samTodoListLocalService.deleteSAMTodoList((SAMTodoList)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return samTodoListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SAMTodoList> getSAMTodoLists(int start, int end) {
		return samTodoListPersistence.findAll(start, end);
	}
	...
	public int getSAMTodoListsCount() {
		return samTodoListPersistence.countAll();
	}
	 ...
	 */
	public com.liferay.samplealloymvc.service.SAMTodoItemLocalService getSAMTodoItemLocalService() {
	...
	public void setSAMTodoItemLocalService(
		com.liferay.samplealloymvc.service.SAMTodoItemLocalService samTodoItemLocalService) {
	 ...
	 */
	public SAMTodoListLocalService getSAMTodoListLocalService() {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.samplealloymvc.model.SAMTodoList",
			samTodoListLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SAMTodoListLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = samTodoListPersistence.getDataSource();
	...
	@BeanReference(type = com.liferay.samplealloymvc.service.SAMTodoItemLocalService.class)
	protected com.liferay.samplealloymvc.service.SAMTodoItemLocalService samTodoItemLocalService;
	@BeanReference(type = SAMTodoItemPersistence.class)
	protected SAMTodoItemPersistence samTodoItemPersistence;
	@BeanReference(type = SAMTodoListLocalService.class)
	protected SAMTodoListLocalService samTodoListLocalService;
	...
	private SAMTodoListLocalServiceClpInvoker _clpInvoker = new SAMTodoListLocalServiceClpInvoker();
}