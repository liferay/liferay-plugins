...
public class ClpSerializer {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.liferay.samplealloymvc.NoSuchAssetException")) {
			return new com.liferay.samplealloymvc.NoSuchAssetException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.samplealloymvc.NoSuchCheckoutException")) {
			return new com.liferay.samplealloymvc.NoSuchCheckoutException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.samplealloymvc.NoSuchDefinitionException")) {
			return new com.liferay.samplealloymvc.NoSuchDefinitionException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals("com.liferay.samplealloymvc.NoSuchTypeException")) {
			return new com.liferay.samplealloymvc.NoSuchTypeException(throwable.getMessage(),
				throwable.getCause());
		}
