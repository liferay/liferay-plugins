...
/**
 * Provides the local service utility for SAMTodoItem. This utility wraps
 * {@link com.liferay.samplealloymvc.service.impl.SAMTodoItemLocalServiceImpl} and is the
 ...
 * @see com.liferay.samplealloymvc.service.base.SAMTodoItemLocalServiceBaseImpl
 * @see com.liferay.samplealloymvc.service.impl.SAMTodoItemLocalServiceImpl
 * @generated
 */
@ProviderType
public class SAMTodoItemLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.samplealloymvc.service.impl.SAMTodoItemLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.samplealloymvc.model.SAMTodoItem addSAMTodoItem(
		com.liferay.samplealloymvc.model.SAMTodoItem samTodoItem) {
		return getService().addSAMTodoItem(samTodoItem);
	}
	...
	*/
	public static com.liferay.samplealloymvc.model.SAMTodoItem createSAMTodoItem(
		long samTodoItemId) {
		return getService().createSAMTodoItem(samTodoItemId);
	}
	...
	*/
	public static com.liferay.samplealloymvc.model.SAMTodoItem deleteSAMTodoItem(
		com.liferay.samplealloymvc.model.SAMTodoItem samTodoItem) {
		return getService().deleteSAMTodoItem(samTodoItem);
	}
	...
	*/
	public static com.liferay.samplealloymvc.model.SAMTodoItem deleteSAMTodoItem(
		long samTodoItemId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteSAMTodoItem(samTodoItemId);
	}

	public static com.liferay.samplealloymvc.model.SAMTodoItem fetchSAMTodoItem(
		long samTodoItemId) {
		return getService().fetchSAMTodoItem(samTodoItemId);
	}
	...
	* @throws PortalException if a s a m todo item with the primary key could not be found
	*/
	public static com.liferay.samplealloymvc.model.SAMTodoItem getSAMTodoItem(
		long samTodoItemId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getSAMTodoItem(samTodoItemId);
	}
	...
	*/
	public static com.liferay.samplealloymvc.model.SAMTodoItem updateSAMTodoItem(
		com.liferay.samplealloymvc.model.SAMTodoItem samTodoItem) {
		return getService().updateSAMTodoItem(samTodoItem);
	}
	...
	*/
	public static int getSAMTodoItemsCount() {
		return getService().getSAMTodoItemsCount();
	}
	...
	*/
	public static java.util.List<com.liferay.samplealloymvc.model.SAMTodoItem> getSAMTodoItems(
		int start, int end) {
		return getService().getSAMTodoItems(start, end);
	}
	...
	*/
	...
	public static SAMTodoItemLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					SAMTodoItemLocalService.class.getName());
			...
			ReferenceRegistry.registerReference(SAMTodoItemLocalServiceUtil.class,
				"_service");
		}
	...
	private static SAMTodoItemLocalService _service;
}