...
/**
 * Provides the local service interface for SAMTodoItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SAMTodoItemLocalServiceUtil
...
public interface SAMTodoItemLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SAMTodoItemLocalServiceUtil} to access the s a m todo item local service. Add custom service methods to {@link com.liferay.samplealloymvc.service.impl.SAMTodoItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
