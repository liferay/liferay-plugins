...
/**
 * <a href="AMSCheckoutLocalServiceBaseImpl.java.html"><b><i>View Source</i></b>
 * </a>
 *
 * @author Brian Wing Shun Chan
 */
public abstract class AMSCheckoutLocalServiceBaseImpl
	implements AMSCheckoutLocalService {
	public AMSCheckout addAMSCheckout(AMSCheckout amsCheckout)
		throws SystemException {
		amsCheckout.setNew(true);

		return amsCheckoutPersistence.update(amsCheckout, false);
	}

	public AMSCheckout createAMSCheckout(long amsCheckoutId) {
		return amsCheckoutPersistence.create(amsCheckoutId);
	}

	public void deleteAMSCheckout(long amsCheckoutId)
		throws PortalException, SystemException {
		amsCheckoutPersistence.remove(amsCheckoutId);
	}

	public void deleteAMSCheckout(AMSCheckout amsCheckout)
		throws SystemException {
		amsCheckoutPersistence.remove(amsCheckout);
	}

	@SuppressWarnings("unchecked")
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return amsCheckoutPersistence.findWithDynamicQuery(dynamicQuery);
	}

	@SuppressWarnings("unchecked")
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return amsCheckoutPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return amsCheckoutPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AMSCheckout getAMSCheckout(long amsCheckoutId)
		throws PortalException, SystemException {
		return amsCheckoutPersistence.findByPrimaryKey(amsCheckoutId);
	}

	public List<AMSCheckout> getAMSCheckouts(int start, int end)
		throws SystemException {
		return amsCheckoutPersistence.findAll(start, end);
	}

	public int getAMSCheckoutsCount() throws SystemException {
		return amsCheckoutPersistence.countAll();
	}

	public AMSCheckout updateAMSCheckout(AMSCheckout amsCheckout)
		throws SystemException {
		amsCheckout.setNew(false);

		return amsCheckoutPersistence.update(amsCheckout, true);
	}

	public AMSCheckout updateAMSCheckout(AMSCheckout amsCheckout, boolean merge)
		throws SystemException {
		amsCheckout.setNew(false);

		return amsCheckoutPersistence.update(amsCheckout, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = amsCheckoutPersistence.getDataSource();
