...
import com.liferay.ams.model.AMSDefinitionSoap;
...
/**
 * <a href="AMSDefinitionModelImpl.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 * @see       AMSDefinitionImpl
 * @see       com.liferay.ams.model.AMSDefinition
 * @see       com.liferay.ams.model.AMSDefinitionModel
 * @generated
 */
public class AMSDefinitionModelImpl extends BaseModelImpl<AMSDefinition> {
	public static final String TABLE_NAME = "AMS_AMSDefinition";
	...
	public static final String TABLE_SQL_CREATE = "create table AMS_AMSDefinition (assetDefinitionId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,amsTypeId LONG,manufacturer VARCHAR(75) null,model VARCHAR(75) null,orderDate DATE null,quantity INTEGER,price DOUBLE)";
	public static final String TABLE_SQL_DROP = "drop table AMS_AMSDefinition";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.ams.model.AMSDefinition"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.ams.model.AMSDefinition"),
			true);

	public static AMSDefinition toModel(AMSDefinitionSoap soapModel) {
		AMSDefinition model = new AMSDefinitionImpl();
	...
	public static List<AMSDefinition> toModels(AMSDefinitionSoap[] soapModels) {
		List<AMSDefinition> models = new ArrayList<AMSDefinition>(soapModels.length);

		for (AMSDefinitionSoap soapModel : soapModels) {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.liferay.ams.model.AMSDefinition"));

	public AMSDefinitionModelImpl() {
	}
	...
	public ExpandoBridge getExpandoBridge() {
		if (_expandoBridge == null) {
			_expandoBridge = ExpandoBridgeFactoryUtil.getExpandoBridge(getCompanyId(),
					AMSDefinition.class.getName(), getPrimaryKey());
		}
	...
	public Object clone() {
		AMSDefinitionImpl clone = new AMSDefinitionImpl();
	...
	public boolean equals(Object obj) {
		...
		AMSDefinition amsDefinition = null;

		try {
			amsDefinition = (AMSDefinition)obj;
		}
