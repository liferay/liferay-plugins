...
import com.liferay.ams.service.AMSAssetLocalServiceUtil;
import com.liferay.ams.service.AMSCheckoutLocalServiceUtil;
import com.liferay.ams.service.AMSDefinitionLocalServiceUtil;
import com.liferay.ams.service.AMSTypeLocalServiceUtil;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			AMSAssetLocalServiceUtil.clearService();

			AMSCheckoutLocalServiceUtil.clearService();

			AMSDefinitionLocalServiceUtil.clearService();

			AMSTypeLocalServiceUtil.clearService();
		}
	}
