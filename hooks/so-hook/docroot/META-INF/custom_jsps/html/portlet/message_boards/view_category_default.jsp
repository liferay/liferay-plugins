...
>
	...
	<liferay-ui:search-container-results>
		...
		if (category != null) {
			...
			results = MBThreadServiceUtil.getGroupThreads(scopeGroupId, 0, WorkflowConstants.STATUS_APPROVED, false, false, searchContainer.getStart(), searchContainer.getEnd());
			total = MBThreadServiceUtil.getGroupThreadsCount(scopeGroupId, 0, WorkflowConstants.STATUS_APPROVED, false, false);
		}
	...
	>
		...
		boolean readThread = MBThreadFlagLocalServiceUtil.hasThreadFlag(themeDisplay.getUserId(), thread);
