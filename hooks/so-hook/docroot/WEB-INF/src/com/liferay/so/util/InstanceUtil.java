...
public class InstanceUtil {
	...
	protected static void addCommunityLayouts(long companyId)
		throws Exception {
		...
		addPortlets(
			group, layout, PortletPropsKeys.SITE_LAYOUT_PORTLETS + "home.");
		...
		addPortlets(
			group, layout, PortletPropsKeys.SITE_LAYOUT_PORTLETS + "calendar.");
		...
		addPortlets(
			group, layout,
			PortletPropsKeys.SITE_LAYOUT_PORTLETS + "documents.");
		...
		addPortlets(
			group, layout, PortletPropsKeys.SITE_LAYOUT_PORTLETS + "forums.");
		...
		addPortlets(
			group, layout, PortletPropsKeys.SITE_LAYOUT_PORTLETS + "blog.");
		...
		addPortlets(
			group, layout, PortletPropsKeys.SITE_LAYOUT_PORTLETS + "wiki.");
		...
		addPortlets(
			group, layout, PortletPropsKeys.SITE_LAYOUT_PORTLETS + "members.");
	...
	protected static void addPortlets(Group group, Layout layout, String prefix)
		throws Exception {
	...
	protected static void configureAssetPublisher(Layout layout) throws Exception {
	...
	protected static void configureMessageBoards(Layout layout) throws Exception {
		PortletPreferences portletSetup =
			PortletPreferencesFactoryUtil.getLayoutPortletSetup(
