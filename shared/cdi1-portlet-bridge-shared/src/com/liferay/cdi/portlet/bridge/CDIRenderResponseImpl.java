 ...
 * @author Neil Griffin
 */
public class CDIRenderResponseImpl extends CDIRenderResponse {

	public CDIRenderResponseImpl(
	...
	public void sendError(int statusCode) throws IOException {
		_httpServletResponseAdapter.sendError(statusCode);
	}

	@Override
	public void sendError(int statusCode, String msg) throws IOException {
		_httpServletResponseAdapter.sendError(statusCode, msg);
	}
	...
	public void setCharacterEncoding(String characterEncoding) {
		...
		_httpServletResponseAdapter.setCharacterEncoding(characterEncoding);
	}
	...
	public void setStatus(int status, String name) {
		...
		_httpServletResponseAdapter.setStatus(status, name);
	}
