 ...
 * @author Neil Griffin
 */
public class CDIRenderRequestImpl extends CDIRenderRequest {

	public CDIRenderRequestImpl(
	...
	public String getMethod() {
		...
		return _httpServletRequestAdapter.getMethod();
	}
	...
	@Override
	public RequestDispatcher getRequestDispatcher(String location) {

		return _httpServletRequestAdapter.getRequestDispatcher(location);
	}
	...
	public void setCharacterEncoding(String characterEncoding)
		...
		_httpServletRequestAdapter.setCharacterEncoding(characterEncoding);
	}
