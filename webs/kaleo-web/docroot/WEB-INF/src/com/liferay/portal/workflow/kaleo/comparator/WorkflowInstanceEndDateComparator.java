...
public class WorkflowInstanceEndDateComparator
	...
	public static String ORDER_BY_ASC = "endDate ASC, kaleoInstanceId ASC";

	public static String ORDER_BY_DESC = "endDate DESC, kaleoInstanceId DESC";

	public static String[] ORDER_BY_FIELDS = {"endDate", "kaleoInstanceId"};
