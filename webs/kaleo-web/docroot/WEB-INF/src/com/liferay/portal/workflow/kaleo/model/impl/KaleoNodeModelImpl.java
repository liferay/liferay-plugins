...
public class KaleoNodeModelImpl extends BaseModelImpl<KaleoNode> {
	...
	public KaleoNode toEscapedModel() {
		if (isEscapedModel()) {
			...
			model = (KaleoNode)Proxy.newProxyInstance(KaleoNode.class.getClassLoader(),
					new Class[] { KaleoNode.class },
