...
/**
 * <a href="KaleoTaskInstanceAssignmentLocalServiceBaseImpl.java.html"><b>
 * <i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public abstract class KaleoTaskInstanceAssignmentLocalServiceBaseImpl
	...
	public KaleoTaskInstanceAssignment addKaleoTaskInstanceAssignment(
		...
		return kaleoTaskInstanceAssignmentPersistence.update(kaleoTaskInstanceAssignment,
			false);
	}

	public KaleoTaskInstanceAssignment createKaleoTaskInstanceAssignment(
		long kaleoTaskInstanceAssignmentId) {
		return kaleoTaskInstanceAssignmentPersistence.create(kaleoTaskInstanceAssignmentId);
	}

	public void deleteKaleoTaskInstanceAssignment(
		long kaleoTaskInstanceAssignmentId)
		throws PortalException, SystemException {
		kaleoTaskInstanceAssignmentPersistence.remove(kaleoTaskInstanceAssignmentId);
	}

	public void deleteKaleoTaskInstanceAssignment(
		KaleoTaskInstanceAssignment kaleoTaskInstanceAssignment)
		throws SystemException {
		kaleoTaskInstanceAssignmentPersistence.remove(kaleoTaskInstanceAssignment);
	}

	public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return kaleoTaskInstanceAssignmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public int dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return kaleoTaskInstanceAssignmentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public KaleoTaskInstanceAssignment getKaleoTaskInstanceAssignment(
		long kaleoTaskInstanceAssignmentId)
		throws PortalException, SystemException {
		return kaleoTaskInstanceAssignmentPersistence.findByPrimaryKey(kaleoTaskInstanceAssignmentId);
	}

	public List<KaleoTaskInstanceAssignment> getKaleoTaskInstanceAssignments(
		int start, int end) throws SystemException {
		return kaleoTaskInstanceAssignmentPersistence.findAll(start, end);
	}

	public int getKaleoTaskInstanceAssignmentsCount() throws SystemException {
		return kaleoTaskInstanceAssignmentPersistence.countAll();
	}

	public KaleoTaskInstanceAssignment updateKaleoTaskInstanceAssignment(
		KaleoTaskInstanceAssignment kaleoTaskInstanceAssignment)
		throws SystemException {
