...
/**
 * The base implementation of the kaleo task form local service.
 *
 * <p>
...
public abstract class KaleoTaskFormLocalServiceBaseImpl
	implements KaleoTaskFormLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public KaleoTaskForm addKaleoTaskForm(KaleoTaskForm kaleoTaskForm)
		...
		kaleoTaskForm = kaleoTaskFormPersistence.update(kaleoTaskForm, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(kaleoTaskForm);
			}
	...
	public void deleteKaleoTaskForm(long kaleoTaskFormId)
		...
		KaleoTaskForm kaleoTaskForm = kaleoTaskFormPersistence.remove(kaleoTaskFormId);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteKaleoTaskForm(KaleoTaskForm kaleoTaskForm)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getKaleoTaskFormsCount() throws SystemException {
	...
	public KaleoTaskForm updateKaleoTaskForm(KaleoTaskForm kaleoTaskForm)
		throws SystemException {
		return updateKaleoTaskForm(kaleoTaskForm, true);
	}
	...
	public KaleoTaskForm updateKaleoTaskForm(KaleoTaskForm kaleoTaskForm,
		...
		kaleoTaskForm = kaleoTaskFormPersistence.update(kaleoTaskForm, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.portal.workflow.kaleo.model.KaleoTaskForm",
	...
	private static Log _log = LogFactoryUtil.getLog(KaleoTaskFormLocalServiceBaseImpl.class);
