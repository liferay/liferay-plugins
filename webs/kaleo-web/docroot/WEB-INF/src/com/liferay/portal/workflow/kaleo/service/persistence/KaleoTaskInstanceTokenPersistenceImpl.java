...
public class KaleoTaskInstanceTokenPersistenceImpl extends BasePersistenceImpl<KaleoTaskInstanceToken>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_KALEOINSTANCEID = new FinderPath(KaleoTaskInstanceTokenModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_G_C_ACN_ACP_C = new FinderPath(KaleoTaskInstanceTokenModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskInstanceTokenModelImpl.FINDER_CACHE_ENABLED,
			FINDER_CLASS_NAME_LIST, "findByG_C_ACN_ACP_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_C_ACN_ACP_C = new FinderPath(KaleoTaskInstanceTokenModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskInstanceTokenModelImpl.FINDER_CACHE_ENABLED,
			FINDER_CLASS_NAME_LIST, "countByG_C_ACN_ACP_C",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Long.class.getName(),
				Boolean.class.getName()
	...
	public List<KaleoTaskInstanceToken> findByG_C_ACN_ACP_C(long groupId,
		long companyId, String assigneeClassName, long assigneeClassPK,
		boolean completed) throws SystemException {
		return findByG_C_ACN_ACP_C(groupId, companyId, assigneeClassName,
			assigneeClassPK, completed, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	...
	public List<KaleoTaskInstanceToken> findByG_C_ACN_ACP_C(long groupId,
		...
		return findByG_C_ACN_ACP_C(groupId, companyId, assigneeClassName,
			assigneeClassPK, completed, start, end, null);
	}
	...
	public List<KaleoTaskInstanceToken> findByG_C_ACN_ACP_C(long groupId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		Object[] finderArgs = new Object[] {
				new Long(groupId), new Long(companyId),
		...
		List<KaleoTaskInstanceToken> list = (List<KaleoTaskInstanceToken>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_G_C_ACN_ACP_C,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				query.append(_FINDER_COLUMN_G_C_ACN_ACP_C_GROUPID_2);

				query.append(_FINDER_COLUMN_G_C_ACN_ACP_C_COMPANYID_2);

				if (assigneeClassName == null) {
					query.append(_FINDER_COLUMN_G_C_ACN_ACP_C_ASSIGNEECLASSNAME_1);
				}
				else {
					if (assigneeClassName.equals(StringPool.BLANK)) {
						query.append(_FINDER_COLUMN_G_C_ACN_ACP_C_ASSIGNEECLASSNAME_3);
					}
					else {
						query.append(_FINDER_COLUMN_G_C_ACN_ACP_C_ASSIGNEECLASSNAME_2);
					}
				}

				query.append(_FINDER_COLUMN_G_C_ACN_ACP_C_ASSIGNEECLASSPK_2);

				query.append(_FINDER_COLUMN_G_C_ACN_ACP_C_COMPLETED_2);
				...
				FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_G_C_ACN_ACP_C,
					finderArgs, list);
	...
	public KaleoTaskInstanceToken findByG_C_ACN_ACP_C_First(long groupId,
		long companyId, String assigneeClassName, long assigneeClassPK,
		boolean completed, OrderByComparator orderByComparator)
		throws NoSuchTaskInstanceTokenException, SystemException {
		List<KaleoTaskInstanceToken> list = findByG_C_ACN_ACP_C(groupId,
				companyId, assigneeClassName, assigneeClassPK, completed, 0, 1,
				orderByComparator);
	...
	public KaleoTaskInstanceToken findByG_C_ACN_ACP_C_Last(long groupId,
		long companyId, String assigneeClassName, long assigneeClassPK,
		boolean completed, OrderByComparator orderByComparator)
		throws NoSuchTaskInstanceTokenException, SystemException {
		int count = countByG_C_ACN_ACP_C(groupId, companyId, assigneeClassName,
				assigneeClassPK, completed);

		List<KaleoTaskInstanceToken> list = findByG_C_ACN_ACP_C(groupId,
				companyId, assigneeClassName, assigneeClassPK, completed,
				count - 1, count, orderByComparator);
	...
	public KaleoTaskInstanceToken[] findByG_C_ACN_ACP_C_PrevAndNext(
		long kaleoTaskInstanceTokenId, long groupId, long companyId,
		...
		try {
			...
			array[0] = getByG_C_ACN_ACP_C_PrevAndNext(session,
					kaleoTaskInstanceToken, groupId, companyId,
					assigneeClassName, assigneeClassPK, completed,
					orderByComparator, true);

			array[1] = kaleoTaskInstanceToken;

			array[2] = getByG_C_ACN_ACP_C_PrevAndNext(session,
					kaleoTaskInstanceToken, groupId, companyId,
					assigneeClassName, assigneeClassPK, completed,
					orderByComparator, false);
	...
	protected KaleoTaskInstanceToken getByG_C_ACN_ACP_C_PrevAndNext(
		Session session, KaleoTaskInstanceToken kaleoTaskInstanceToken,
		long groupId, long companyId, String assigneeClassName,
	...
	public void removeByG_C_ACN_ACP_C(long groupId, long companyId,
		String assigneeClassName, long assigneeClassPK, boolean completed)
		throws SystemException {
		for (KaleoTaskInstanceToken kaleoTaskInstanceToken : findByG_C_ACN_ACP_C(
				groupId, companyId, assigneeClassName, assigneeClassPK,
				completed)) {
			remove(kaleoTaskInstanceToken);
		}
	}
	...
	public int countByG_C_ACN_ACP_C(long groupId, long companyId,
		String assigneeClassName, long assigneeClassPK, boolean completed)
		throws SystemException {
		Object[] finderArgs = new Object[] {
				new Long(groupId), new Long(companyId),
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_C_ACN_ACP_C,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_C_ACN_ACP_C,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_G_C_ACN_ACP_C_GROUPID_2 = "kaleoTaskInstanceToken.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_ACN_ACP_C_COMPANYID_2 = "kaleoTaskInstanceToken.companyId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_ACN_ACP_C_ASSIGNEECLASSNAME_1 =
		"kaleoTaskInstanceToken.assigneeClassName IS NULL AND ";
	private static final String _FINDER_COLUMN_G_C_ACN_ACP_C_ASSIGNEECLASSNAME_2 =
		"kaleoTaskInstanceToken.assigneeClassName = ? AND ";
	private static final String _FINDER_COLUMN_G_C_ACN_ACP_C_ASSIGNEECLASSNAME_3 =
		"(kaleoTaskInstanceToken.assigneeClassName IS NULL OR kaleoTaskInstanceToken.assigneeClassName = ?) AND ";
	private static final String _FINDER_COLUMN_G_C_ACN_ACP_C_ASSIGNEECLASSPK_2 = "kaleoTaskInstanceToken.assigneeClassPK = ? AND ";
	private static final String _FINDER_COLUMN_G_C_ACN_ACP_C_COMPLETED_2 = "kaleoTaskInstanceToken.completed = ?";
