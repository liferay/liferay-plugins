...
public class KaleoTaskInstanceTokenPersistenceImpl extends BasePersistenceImpl<KaleoTaskInstanceToken>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_C_G_ACN_ACP_CD = new FinderPath(KaleoTaskInstanceTokenModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskInstanceTokenModelImpl.FINDER_CACHE_ENABLED,
			FINDER_CLASS_NAME_LIST, "findByC_G_ACN_ACP_CD",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_ACN_ACP_CD = new FinderPath(KaleoTaskInstanceTokenModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskInstanceTokenModelImpl.FINDER_CACHE_ENABLED,
			FINDER_CLASS_NAME_LIST, "countByC_G_ACN_ACP_CD",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Long.class.getName(),
				Boolean.class.getName()
	...
	public List<KaleoTaskInstanceToken> findByC_G_ACN_ACP_CD(long companyId,
		long groupId, String assigneeClassName, long assigneeClassPK,
		boolean completed) throws SystemException {
		return findByC_G_ACN_ACP_CD(companyId, groupId, assigneeClassName,
	...
	public List<KaleoTaskInstanceToken> findByC_G_ACN_ACP_CD(long companyId,
		...
		List<KaleoTaskInstanceToken> list = (List<KaleoTaskInstanceToken>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_C_G_ACN_ACP_CD,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				query.append(_FINDER_COLUMN_C_G_ACN_ACP_CD_COMPANYID_2);

				query.append(_FINDER_COLUMN_C_G_ACN_ACP_CD_GROUPID_2);

				if (assigneeClassName == null) {
					query.append(_FINDER_COLUMN_C_G_ACN_ACP_CD_ASSIGNEECLASSNAME_1);
				}
				else {
					if (assigneeClassName.equals(StringPool.BLANK)) {
						query.append(_FINDER_COLUMN_C_G_ACN_ACP_CD_ASSIGNEECLASSNAME_3);
					}
					else {
						query.append(_FINDER_COLUMN_C_G_ACN_ACP_CD_ASSIGNEECLASSNAME_2);
					}
				}

				query.append(_FINDER_COLUMN_C_G_ACN_ACP_CD_ASSIGNEECLASSPK_2);

				query.append(_FINDER_COLUMN_C_G_ACN_ACP_CD_COMPLETED_2);
				...
				FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_C_G_ACN_ACP_CD,
					finderArgs, list);
	...
	public KaleoTaskInstanceToken findByC_G_ACN_ACP_CD_First(long companyId,
		long groupId, String assigneeClassName, long assigneeClassPK,
		boolean completed, OrderByComparator orderByComparator)
		throws NoSuchTaskInstanceTokenException, SystemException {
		List<KaleoTaskInstanceToken> list = findByC_G_ACN_ACP_CD(companyId,
				groupId, assigneeClassName, assigneeClassPK, completed, 0, 1,
				orderByComparator);
	...
	public KaleoTaskInstanceToken findByC_G_ACN_ACP_CD_Last(long companyId,
		long groupId, String assigneeClassName, long assigneeClassPK,
		boolean completed, OrderByComparator orderByComparator)
		throws NoSuchTaskInstanceTokenException, SystemException {
		int count = countByC_G_ACN_ACP_CD(companyId, groupId,
				assigneeClassName, assigneeClassPK, completed);

		List<KaleoTaskInstanceToken> list = findByC_G_ACN_ACP_CD(companyId,
				groupId, assigneeClassName, assigneeClassPK, completed,
				count - 1, count, orderByComparator);
	...
	public KaleoTaskInstanceToken[] findByC_G_ACN_ACP_CD_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_G_ACN_ACP_CD_PrevAndNext(session,
					kaleoTaskInstanceToken, companyId, groupId,
					assigneeClassName, assigneeClassPK, completed,
					orderByComparator, true);

			array[1] = kaleoTaskInstanceToken;

			array[2] = getByC_G_ACN_ACP_CD_PrevAndNext(session,
					kaleoTaskInstanceToken, companyId, groupId,
					assigneeClassName, assigneeClassPK, completed,
	...
	protected KaleoTaskInstanceToken getByC_G_ACN_ACP_CD_PrevAndNext(
		Session session, KaleoTaskInstanceToken kaleoTaskInstanceToken,
	...
	public void removeByC_G_ACN_ACP_CD(long companyId, long groupId,
		String assigneeClassName, long assigneeClassPK, boolean completed)
		throws SystemException {
		for (KaleoTaskInstanceToken kaleoTaskInstanceToken : findByC_G_ACN_ACP_CD(
				companyId, groupId, assigneeClassName, assigneeClassPK,
				completed)) {
			remove(kaleoTaskInstanceToken);
		}
	}
	...
	public int countByC_G_ACN_ACP_CD(long companyId, long groupId,
		String assigneeClassName, long assigneeClassPK, boolean completed)
		throws SystemException {
		Object[] finderArgs = new Object[] {
				new Long(companyId), new Long(groupId),
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_C_G_ACN_ACP_CD,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_G_ACN_ACP_CD,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_C_G_ACN_ACP_CD_COMPANYID_2 = "kaleoTaskInstanceToken.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_ACN_ACP_CD_GROUPID_2 = "kaleoTaskInstanceToken.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_ACN_ACP_CD_ASSIGNEECLASSNAME_1 =
		"kaleoTaskInstanceToken.assigneeClassName IS NULL AND ";
	private static final String _FINDER_COLUMN_C_G_ACN_ACP_CD_ASSIGNEECLASSNAME_2 =
		"kaleoTaskInstanceToken.assigneeClassName = ? AND ";
	private static final String _FINDER_COLUMN_C_G_ACN_ACP_CD_ASSIGNEECLASSNAME_3 =
		"(kaleoTaskInstanceToken.assigneeClassName IS NULL OR kaleoTaskInstanceToken.assigneeClassName = ?) AND ";
	private static final String _FINDER_COLUMN_C_G_ACN_ACP_CD_ASSIGNEECLASSPK_2 = "kaleoTaskInstanceToken.assigneeClassPK = ? AND ";
	private static final String _FINDER_COLUMN_C_G_ACN_ACP_CD_COMPLETED_2 = "kaleoTaskInstanceToken.completed = ?";
