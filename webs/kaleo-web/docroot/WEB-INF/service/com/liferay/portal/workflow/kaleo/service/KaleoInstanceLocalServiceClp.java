...
public class KaleoInstanceLocalServiceClp implements KaleoInstanceLocalService {
	...
	public void delete(long kaleoInstanceId)
		...
		try {
			_classLoaderProxy.invoke("delete", new Object[] { paramObj0 });
		}
		catch (Throwable t) {
			if (t instanceof com.liferay.portal.kernel.exception.PortalException) {
				throw (com.liferay.portal.kernel.exception.PortalException)t;
	...
	public void deleteKaleoInstanceByDefinitionId(long kaleoDefinitionId)
		...
		try {
			_classLoaderProxy.invoke("deleteKaleoInstanceByDefinitionId",
				new Object[] { paramObj0 });
		}
		catch (Throwable t) {
			if (t instanceof com.liferay.portal.kernel.exception.PortalException) {
	...
	public int getKaleoInstanceCountByDefinitionAndCompletion(
		...
		try {
			returnObj = _classLoaderProxy.invoke("getKaleoInstanceCountByDefinitionAndCompletion",
					new Object[] { paramObj0, paramObj1 });
		}
		catch (Throwable t) {
			if (t instanceof com.liferay.portal.kernel.exception.SystemException) {
