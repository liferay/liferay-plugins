...
/**
 * <a href="KaleoTaskLocalServiceClp.java.html"><b><i>View Source</i></b></a>
 *
...
public class KaleoTaskLocalServiceClp implements KaleoTaskLocalService {
	...
	public com.liferay.portal.workflow.kaleo.model.KaleoTask addKaleoTask(
		...
		Object paramObj0 = ClpSerializer.translateInput(kaleoTask);
		...
		try {
			returnObj = _classLoaderProxy.invoke("addKaleoTask",
	...
	public com.liferay.portal.workflow.kaleo.model.KaleoTask createKaleoTask(
		...
		try {
			returnObj = _classLoaderProxy.invoke("createKaleoTask",
					new Object[] { paramObj0 });
		}
		catch (Throwable t) {
			if (t instanceof RuntimeException) {
	...
	public void deleteKaleoTask(long kaleoTaskId)
		...
		try {
			_classLoaderProxy.invoke("deleteKaleoTask",
				new Object[] { paramObj0 });
		}
		catch (Throwable t) {
	...
	public com.liferay.portal.workflow.kaleo.model.KaleoTask getKaleoTask(
		...
		try {
			returnObj = _classLoaderProxy.invoke("getKaleoTask",
					new Object[] { paramObj0 });
		}
		catch (Throwable t) {
			if (t instanceof com.liferay.portal.kernel.exception.PortalException) {
	...
	public java.util.List<com.liferay.portal.workflow.kaleo.model.KaleoTask> getKaleoTasks(
		...
		try {
			returnObj = _classLoaderProxy.invoke("getKaleoTasks",
	...
	public int getKaleoTasksCount()
		...
		try {
			returnObj = _classLoaderProxy.invoke("getKaleoTasksCount",
					new Object[0]);
		}
		catch (Throwable t) {
			if (t instanceof com.liferay.portal.kernel.exception.SystemException) {
	...
	public com.liferay.portal.workflow.kaleo.model.KaleoTask updateKaleoTask(
		...
		try {
			returnObj = _classLoaderProxy.invoke("updateKaleoTask",
					new Object[] { paramObj0 });
		}
		catch (Throwable t) {
			if (t instanceof com.liferay.portal.kernel.exception.SystemException) {
	...
	public com.liferay.portal.workflow.kaleo.model.KaleoTask addKaleoTask(
		...
		Object paramObj2 = ClpSerializer.translateInput(task);
	...
	public void deleteKaleoTasksByDefinitionId(long definitionId)
		throws com.liferay.portal.kernel.exception.SystemException {
		Object paramObj0 = new LongWrapper(definitionId);

		try {
			_classLoaderProxy.invoke("deleteKaleoTasksByDefinitionId",
				new Object[] { paramObj0 });
		}
		catch (Throwable t) {
			if (t instanceof com.liferay.portal.kernel.exception.SystemException) {
	...
	public com.liferay.portal.workflow.kaleo.model.KaleoTask getKaleoNodeKaleoTask(
		...
		try {
			returnObj = _classLoaderProxy.invoke("getKaleoNodeKaleoTask",
					new Object[] { paramObj0 });
		}
		catch (Throwable t) {
			if (t instanceof com.liferay.portal.kernel.exception.PortalException) {
