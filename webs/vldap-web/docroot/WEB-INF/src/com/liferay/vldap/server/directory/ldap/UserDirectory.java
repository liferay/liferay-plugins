...
public class UserDirectory extends Directory {
	...
	public UserDirectory(String top, Company company, User user)
		...
		setName(top, company, "cn=" + user.getScreenName(), "Users");
