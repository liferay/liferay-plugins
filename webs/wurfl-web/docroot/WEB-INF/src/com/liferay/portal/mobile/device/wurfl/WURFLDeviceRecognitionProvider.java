...
/**
 * This implementation of {@link DeviceRecognitionProvider} uses WURFL for
 * device recognition
 *
...
public class WURFLDeviceRecognitionProvider
	...
	public Device detectDevice(HttpServletRequest httpServletRequest) {
		...
		if (wurflManager == null) {
			if (_log.isWarnEnabled()) {
				_log.warn("WURFL database was not loaded initialized!");
			}
		...
		net.sourceforge.wurfl.core.Device wurflDevice =
			wurflManager.getDeviceForRequest(httpServletRequest);

		Device device = null;

		if (wurflDevice != null) {
			Map<String, String> capabilities =
				wurflDevice.getCapabilities();
	...
	public void setWurflHolderImpl(WURFLHolderImpl wurflHolder) {
		_wurflHolderImpl = wurflHolder;
	}
