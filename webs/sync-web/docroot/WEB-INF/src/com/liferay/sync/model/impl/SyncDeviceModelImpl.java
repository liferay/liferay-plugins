 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.sync.model.SyncDeviceModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link SyncDeviceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see SyncDeviceImpl
 * @see com.liferay.sync.model.SyncDevice
 * @see com.liferay.sync.model.SyncDeviceModel
 * @generated
 */
@JSON(strict = true)
public class SyncDeviceModelImpl extends BaseModelImpl<SyncDevice>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a sync device model instance should use the {@link com.liferay.sync.model.SyncDevice} interface instead.
	 */
	...
	private static ClassLoader _classLoader = SyncDevice.class.getClassLoader();
