<div class="columns-1-3-1" id="main-content" role="main">
		...
		<tr>
			<td class="portlet-column portlet-column-only portlet-column-topper" id="column-1">
		...
		<tr>
			...
			<td class="aui-w15 portlet-column" id="column-3">
		...
		<div class="portlet-layout">
			...
			<div class="aui-w15 portlet-column" id="column-3">
				$processor.processColumn("column-3", "portlet-column-content")
			</div>
