<div class="columns-3-2-3" id="main-content" role="main">
	<div class="portlet-layout row">
		...
		<div class="portlet-column col-md-4" id="column-2">
	...
	<div class="portlet-layout row">
		<div class="portlet-column portlet-column-first col-md-4" id="column-4">
			$processor.processColumn("column-4", "portlet-column-content portlet-column-content-first")
		</div>

		<div class="portlet-column portlet-column-last col-md-8" id="column-5">
			$processor.processColumn("column-5", "portlet-column-content portlet-column-content-last")
		</div>
	</div>

	<div class="portlet-layout row">
		<div class="portlet-column portlet-column-first col-md-4" id="column-6">
			$processor.processColumn("column-6", "portlet-column-content portlet-column-content-first")
		</div>

		<div class="portlet-column col-md-4" id="column-7">
			$processor.processColumn("column-7", "portlet-column-content")
		</div>

		<div class="portlet-column portlet-column-last col-md-4" id="column-8">
