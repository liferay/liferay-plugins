...
<#if (deviceBrand == 'desktop' || deviceBrand == 'unknown')>
	<@liferay_util["include"] page="/html/portlet/message_boards/view.jsp" strict=true />
<#else>
	<@liferay_util["include"] page="/html/seven_cogs/portlet/message_boards/view.jsp" strict=true />
</#if>